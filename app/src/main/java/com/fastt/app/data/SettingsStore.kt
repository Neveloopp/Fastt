...
class SettingsStore(private val context: Context) {
    ...
    private val tutorialKey = booleanPreferencesKey(PrefsKeys.TUTORIAL_DONE)
    ...
    val tutorialDone: Flow<Boolean> = context.dataStore.data.map { it[tutorialKey] ?: false }
    ...
    suspend fun setTutorialDone(value: Boolean) = context.dataStore.edit { it[tutorialKey] = value }
}
